...
class ExperienceProvider {
  Future<List<Experience>> getExperiences(
    ...
    final url = Uri.parse(
        'http://ec2-52-90-137-95.compute-1.amazonaws.com/api/places/nearby/');
  ...
  Future<ExperienceDetailed> getExperienceDetail(String experienceId) async {
    ...
    final url = Uri.parse(
        'http://ec2-52-90-137-95.compute-1.amazonaws.com/api/places/tp/$experienceId/$userId');
  ...
  Future<List<Department>> getFavoriteExperiencesDepartments() async {
    ...
    final url = Uri.parse(
        'http://ec2-52-90-137-95.compute-1.amazonaws.com/api/users/$userId/favourites/departments/');
  ...
  Future<List<Experience>> getFavoriteExperiences(String departmentId) async {
    ...
    final int userId = UserPreferences().getUserId();
    final url = Uri.parse(
        'http://ec2-52-90-137-95.compute-1.amazonaws.com/api/users/$userId/favourites/departments/$departmentId/');
  ...
  Future<bool> postAddFavoriteExperience(String experienceId) async {
    final url = Uri.parse(
        'http://ec2-52-90-137-95.compute-1.amazonaws.com/api/users/favourite/create/');
    final String userToken = UserPreferences().getToken();
    final int userId = UserPreferences().getUserId();
  ...
  Future<bool> deleteFavoriteExperience(String experienceId) async {
    ...
    final url = Uri.parse(
        'http://ec2-52-90-137-95.compute-1.amazonaws.com/api/users/favourite/${userId}/${experienceId}/');
