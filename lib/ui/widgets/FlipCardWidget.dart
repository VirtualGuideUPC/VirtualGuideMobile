...
class FlipCard extends StatefulWidget {
  ...
  FlipCard({@required this.experience,this.horizontalPadding=0,this.onTap,this.onLongPress, Key key}) : super(key: key);
...
class _FlipCardState extends State<FlipCard> {
  ...
  Widget _buildBackFace(){
    final TextStyle cardTitleStyle=TextStyle(color: Colors.white,fontWeight: FontWeight.bold, fontSize: 15);
    final TextStyle cardDescriptionStyle=TextStyle(color: Colors.white,fontWeight: FontWeight.normal);
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Flexible( fit:FlexFit.loose,
                          child:Text("${experience.avgRanking}(${experience.nComments}) ${experience.province}", overflow:TextOverflow.ellipsis,)
                        )
                      ],
                    )
                  ),
                  Expanded(child: SizedBox()),
                  Flexible( child: Text(experience.name, style: cardTitleStyle,overflow: TextOverflow.ellipsis,)),
                  Expanded(child: SizedBox()),
                  Flexible(flex: 4, fit:FlexFit.tight, child: SingleChildScrollView(child: Text(experience.shortInfo,style:cardDescriptionStyle , textAlign: TextAlign.center,))),
                  Padding(
