...
class _ExplorePageState extends State<ExplorePage>
      ...
      builder:
        ...
        if (snapshot.hasData) {
          ...
          if (numberExperiences == 0) {
            ...
            message =
                numberExperiences.toString() + " Experiencias encontradas";
          }
  ...
  Widget _buildMap(UserBloc userBloc) {
    if (oldCameraPosition['lat'] == null || oldCameraPosition['lng'] == null) {
      ...
      if (newCameraPosition['lat'] == null ||
          newCameraPosition['lng'] == null) {
                ...
                child: ListView(
                  children: places
                      .map((result) => ListTile(
                            ...
                            onTap: () async {
                              final Map locationDetail = await placesBloc
                                  .getLocationDetail(result['place_id']);
                              final double lat = locationDetail["result"]
                                  ["geometry"]["location"]["lat"];
                              final double long = locationDetail["result"]
  ...
  void _showBottomSheet(
      List<Experience> experiences, String title, BuildContext context) {
    Scaffold.of(context)
